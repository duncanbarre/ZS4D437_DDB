...
CLASS zcl_ddb_travel_fill DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS c_travel_table  TYPE tabname VALUE 'ZDDB_TRAVEL'.
...
CLASS ZCL_DDB_TRAVEL_FILL IMPLEMENTATION.
